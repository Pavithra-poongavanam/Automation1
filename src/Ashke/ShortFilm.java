...
import org.testng.annotations.BeforeSuite;
	...
	@BeforeSuite
		...
		@Test(priority = 2)
		public void ShortFilmNavigation() throws InterruptedException
		{
			WebElement ShortFilmElement= driver.findElement(By.xpath("/html/body/app-root/app-core/div[2]/app-sidenav/mat-sidenav-container/mat-sidenav-content/div[1]/ul/li[5]/h2"));
	        highlightElement(driver, ShortFilmElement);
			ShortFilmElement.click();
			Thread.sleep(2000);		
		}
		

		@Test(priority = 3)
		public void SearchShortFilm() throws InterruptedException
		{
			String[] searchTerms = {"Katchi Sera", "Runway 34 rf"};
	        for (String searchTerm : searchTerms) 
	        {
	            System.out.println("Performing search for: " + searchTerm);            
	            WebElement searchInput = driver.findElement(By.xpath("/html/body/app-root/app-core/div[2]/div/app-shortfilmlist/div/div/div/div[1]/app-onnet-search-bar/div/input"));
		...
		@Test(priority = 4)
		public void CreateShortFilm() throws InterruptedException
		{
			WebElement createShortMovieElement = driver.findElement(By.xpath("/html/body/app-root/app-core/div[2]/div/app-shortfilmlist/div/mat-toolbar/div/button/span[1]"));
	        highlightElement(driver, createShortMovieElement);
			createShortMovieElement.click();
		    String currentUrl = driver.getCurrentUrl();
		  System.out.println(currentUrl);
		    if(currentUrl.equals("http://103.81.157.84:8900/content/shortfilm/list"))
		    {
		    ...
		    @Test(priority = 5)
		    public void UploadShortMovie() throws InterruptedException
		    {
		    	WebElement ShortFilm = driver.findElement(By.xpath("//span[text()='ShortFilm']"));
		        highlightElement(driver, ShortFilm);
		    	ShortFilm.click();
		    	Thread.sleep(2000);
		    	WebElement fileInput = driver.findElement(By.cssSelector("input[type='file']"));
		        String filePath = Paths.get("C:\\Users\\User\\Videos\\Captures\\shortmovie.mp4").toAbsolutePath().toString(); 
		    ...
		    public void EditShortFilm() throws Exception
		    {
		    	WebElement Shortfilm= driver.findElement(By.xpath("/html/body/app-root/app-core/div[2]/app-sidenav/mat-sidenav-container/mat-sidenav-content/div[1]/ul/li[5]/h2"));
		        highlightElement(driver, Shortfilm);
		    	Shortfilm.click();
				Thread.sleep(2000);		
				
				WebElement Film1 = driver.findElement(By.xpath("/html/body/app-root/app-core/div[2]/div/app-shortfilmlist/div/div/div/div[2]/div[2]/table/tbody/tr[1]/td[3]/a"));
		        highlightElement(driver, Film1);
				Film1.click();
				Thread.sleep(2000);
		    	...
		    	Thread.sleep(2000);	  
				mainTitleElement.sendKeys("ShortFilm Testing");
		    ...
		    public void SearchTag() throws InterruptedException
		    {
			    ...
			    searchTagElement.sendKeys("Adult");			    	     
			      ...
			      advisorytag.click();
			      Thread.sleep(1000);		      
			      WebElement selectedAdvisoryTag = driver.findElement(By.xpath("//*[@id=\"Metadata\"]/div[2]/div[5]/div[3]/div/ng-multiselect-dropdown/div/div[2]/ul[2]/li[2]"));
		    ...
		    public void CastnCrew() throws InterruptedException
		    {
		    	...
		    	castname.sendKeys("Testing");
		    	Thread.sleep(1000);
		    	WebElement character1 = driver.findElement(By.xpath("/html/body/app-root/app-core/div[2]/div/app-short-film-add-edit/div/form/div[2]/div/div[2]/section[6]/div[2]/div/div/div[1]/div[2]/div[2]/div[1]/input"));
		    	...
		    	crewname.sendKeys("Testing");
		    	Thread.sleep(1000);

		    	WebElement character2 = driver.findElement(By.xpath("/html/body/app-root/app-core/div[2]/div/app-short-film-add-edit/div/form/div[2]/div/div[2]/section[6]/div[3]/div/div/div[1]/div[2]/div[2]/div[1]/input"));
		    ...
		    public void Save()
		    {
		    	WebElement savebutton = driver.findElement(By.xpath("/html/body/app-root/app-core/div[2]/div/app-short-film-add-edit/div/form/footer/div/button[2]"));
