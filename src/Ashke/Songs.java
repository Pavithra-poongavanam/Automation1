...
import org.testng.annotations.BeforeSuite;
	...
	@BeforeSuite
		...
		@Test(priority = 2)
		public void SongNavigation() throws InterruptedException
		{
			WebElement SongElement= driver.findElement(By.xpath("/html/body/app-root/app-core/div[2]/app-sidenav/mat-sidenav-container/mat-sidenav-content/div[1]/ul/li[4]"));
	    	highlightElement(driver, SongElement);
			SongElement.click();
			Thread.sleep(2000);		
		}
		...
		{
			String[] searchTerms = {"Katchi Sera", "Devara"};
	        for (String searchTerm : searchTerms) 
	        {
	            System.out.println("Performing search for: " + searchTerm);            
	            WebElement searchInput = driver.findElement(By.xpath("/html/body/app-root/app-core/div[2]/div/app-songslist/div/div/div/div[1]/app-onnet-search-bar/div/input"));
		...
		@Test(priority = 4)
		public void CreateSong() throws InterruptedException
		{
			WebElement createSongElement = driver.findElement(By.xpath("/html/body/app-root/app-core/div[2]/div/app-songslist/div/mat-toolbar/div/button/span[1]"));
	    	highlightElement(driver, createSongElement);
			createSongElement.click();
		    String currentUrl = driver.getCurrentUrl();
		//   System.out.println(currentUrl);
		    if(currentUrl.equals("http://103.81.157.84:8900/content/songs/list"))
		    {
		    ...
		    @Test(priority = 5)
		    public void UploadSong() throws InterruptedException
		    {
		    	WebElement songElement= driver.findElement(By.xpath("//*[@id=\"mat-button-toggle-4-button\"]/span"));
		    	highlightElement(driver, songElement);
		    	songElement.click();
		    	Thread.sleep(2000);
		    	WebElement fileInput = driver.findElement(By.cssSelector("input[type='file']"));
		        String filePath = Paths.get("C:\\Users\\User\\Videos\\Captures\\song.mp4").toAbsolutePath().toString(); 
		    ...
		    {
		    	WebElement songElement= driver.findElement(By.xpath("/html/body/app-root/app-core/div[2]/app-sidenav/mat-sidenav-container/mat-sidenav-content/div[1]/ul/li[4]/h2"));
		    	highlightElement(driver, songElement);
				songElement.click();
				Thread.sleep(2000);		
				
				WebElement song1 = driver.findElement(By.xpath("/html/body/app-root/app-core/div[2]/div/app-songslist/div/div/div/div[2]/div[2]/table/tbody/tr[1]/td[3]/a"));
		    	highlightElement(driver, song1);
				song1.click();
				Thread.sleep(2000);
		    	...
		    	Thread.sleep(2000);	  
				mainTitleElement.sendKeys("Song Testing");
		    ...
		    public void CastnCrew() throws InterruptedException
		    {
		    	...
		    	Thread.sleep(1000);
		    	WebElement character1 = driver.findElement(By.xpath("/html/body/app-root/app-core/div[2]/div/app-songsadd-edit/div/form/div[2]/div/div[2]/section[6]/div[2]/div/div/div[1]/div[2]/div[2]/div[1]/input"));
		    	...
		    	WebElement character2 = driver.findElement(By.xpath("/html/body/app-root/app-core/div[2]/div/app-songsadd-edit/div/form/div[2]/div/div[2]/section[6]/div[3]/div/div/div[1]/div[2]/div[2]/div[1]/input"));
		    ...
		    public void Save()
		    {
		    	WebElement savebutton = driver.findElement(By.xpath("/html/body/app-root/app-core/div[2]/div/app-songsadd-edit/div/form/footer/div/button[2]/span[1]"));
